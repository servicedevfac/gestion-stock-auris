...
<head>
  ...
  <title>Gest_Stock-Auris — Connexion</title>
  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <div class="login-footer">
        &copy; <script>document.write(new Date().getFullYear())</script> Gest_Stock-Auris —
        <a href="https://www.attouco.com/" target="_blank">Attouco</a>
      </div>
    </div>
  </div>
